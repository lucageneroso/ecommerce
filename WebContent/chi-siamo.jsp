...
<body>
    ...
    <p>
    La nostra azienda è stata fondata nel 2018 da tre amici: Luca, Pietro e Riccardo, con una passione comune per l'innovazione nel settore dei prodotti per la casa. 
    Il loro viaggio è iniziato con una semplice idea: rendere più accessibili e convenienti i prodotti di qualità per la casa, fornendo un servizio diretto e personalizzato ai clienti.
    </p>
    <h2>Il nostro Team</h2>
    <p>
    Il nostro team è composto da professionisti con una vasta esperienza nel settore dei prodotti per la casa, uniti dalla passione per l'eccellenza e il servizio clienti. 
